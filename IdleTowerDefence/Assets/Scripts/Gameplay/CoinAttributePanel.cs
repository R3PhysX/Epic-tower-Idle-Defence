...
public class CoinAttributePanel : AttributePanel
{
    
    public CoinAttributeData attributeData;
    public Transform contentPanel;
    public GameObject unlockAttributePanel;
    public CustomButton unlockButton;
    public TMP_Text attributeNameText;
    public TMP_Text costText;
    public GameObject noAttributePanel;
    private int cost = 0;
    ...
    internal override void InitializeAttributes()
    {
        if (isFactory)
        {
            ...
            noAttributePanel?.SetActive(true);
        ...
        foreach (AttributeData attributeData in attributeData.attributes)
        {
            ...
            else
            {
                ...
                if (attributeData.savedData.IsUnlocked == true)
                    noAttributePanel?.SetActive(false);
            }
        }
    }
